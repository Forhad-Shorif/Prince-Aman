  ...
  return (
    <div className="absolute inset-0 bg-black/85 backdrop-blur-md flex flex-col items-center justify-center z-50 p-4 animate-fade-in select-none">
      <div className="bg-slate-900 border border-slate-700/80 p-6 rounded-3xl text-center max-w-xs w-full shadow-2xl relative overflow-hidden">
        ...
        {/* উইন হলে ব্যাকগ্রাউন্ডে ভেসে ওঠা আবছা/ঝাপসা ইমেজ (Overlay Image) */}
        {isWin && (
          <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-20 blur-[1px] z-0">
            <img
              src="https://cdn-icons-png.flaticon.com/512/3112/3112946.png" // কাঙ্ক্ষিত ইমেজের URL
        ...
        {/* কন্টেন্টগুলো যাতে ইমেজের উপরে স্পষ্ট থাকে তার জন্য relative z-10 */}
